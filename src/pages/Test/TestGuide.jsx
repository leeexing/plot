...
const step1 = <div>阅读本页测试须知，确认了解后，点击<span style={{color: "red"}}>【开始测试】</span>进行图像测试</div>
const step2 = <div >图像测试。对图像进行一系列图像操作按钮查看图像显示效果，点击右下方的【<Icon type="swap" style={{color: "#eb2f96"}} />】可切换图像。
  若图像显示没有问题，<span style={{color: "#52c41a"}}>【直接退出】</span>即可；如有问题，请点击<span style={{color: "red"}}>【填写反馈问题】</span></div>
const step3 = <div>填写反馈表单。请在问题描述中详细填写图像显示过程中产生的问题，然后点击<span style={{color: "red"}}>【提交反馈】</span>完成图像测试</div>
