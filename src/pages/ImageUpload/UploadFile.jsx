  ...
  componentDidMount () {
    ...
    fnProps.forEach((fnProp) => {
      if (typeof fnProp === 'string') {
        ...
        // this[fnProp] = this.state.file[fnProp]()
      } else {
        this.setState({
          [fnProp.key]: this.state.file[fnProp.fn]()
        })
        // this[fnProp.key] = this.state.file[fnProp.fn]()
      }
    })
      ...
      <div className="uploader-file">
        ...
        <div className="uploader-file-info">
          ...
          <div className="uploader-file-status">
            <span v-show="status !== 'uploading'">{this.statusText()}</span>
            <span v-show="status === 'uploading'">
              <span>{this.progressStyle().progress}</span>
              <em>{this.formatedAverageSpeed()}</em>
              <i>{this.formatedTimeRemaining()}</i>
            </span>
          </div>
